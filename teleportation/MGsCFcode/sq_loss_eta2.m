function [F] = sq_loss_eta(T, l, t, e, operation, g, eta, sigma)
warning('off')
  ...
  1+eta.^2.*g.^2).*sinh(2.*ra))).*pi.^(-1).*r)...
    ...
    case 'ps'
        F=...
            integral3(@(r,theta,ra)...
            ra.*exp(-ra.^2./sigma).*2./sigma.*...
            (exp(1).^((1/2).*(((-1)+eta.^2).*g.^2.*r.^2+r.^2.*((-2)+l.^2.*((-2) ...
              +((-2)+e).*t.*((-1)+T))+e.*t.*((-1)+T)).*(2+l.^2.*((-2)+((-2)+e).* ...
              t.*((-1)+T))+e.*(t+(-1).*t.*T)).^(-1)+8.*eta.*g.*l.*r.^2.*t.^(1/2) ...
              .*T.^(1/2).*(2+l.^2.*((-2)+((-2)+e).*t.*((-1)+T))+e.*(t+(-1).*t.* ...
              T)).^(-1)+eta.^2.*g.^2.*r.^2.*(2+l.^2.*((-2)+((-2)+e).*t.*((-1)+T) ...
              )+e.*(t+(-1).*t.*T)).^(-1).*((-2)+(-1).*e.*t.*(1+T)+l.^2.*(2+((-2) ...
              +e).*t.*(1+T)))+(-1).*norm(exp(1).^((sqrt(-1)*(-1)).*theta).*r.*( ...
              exp(1).^((sqrt(-1)*2).*theta).*cosh(ra)+sinh(ra))).^2+(-1).*norm(( ...
              -1).*exp(1).^((sqrt(-1)*(-1)).*theta).*eta.*g.*r.*(exp(1).^((sqrt( ...
              -1)*2).*theta).*cosh(ra)+sinh(ra))).^2)).*((-2).*l.^2+e.*((-1)+ ...
              l.^2)).^(-1).*pi.^(-1).*r.*(2+l.^2.*((-2)+((-2)+e).*t.*((-1)+T))+ ...
                  e.*(t+(-1).*t.*T)).^(-1).*(e.^2.*((-1)+l.^2).^2.*t.*((-1)+T+ ...
              eta.^2.*g.^2.*r.^2.*T)+4.*l.^2.*((-1)+r.^2+(-2).*eta.*g.*l.*r.^2.* ...
              t.^(1/2).*T.^(1/2)+l.^2.*(1+t.*((-1)+T+eta.^2.*g.^2.*r.^2.*T)))+( ...
              -2).*e.*((-1)+l.^2).*((-1)+(-2).*eta.*g.*l.*r.^2.*t.^(1/2).*T.^( ...
              1/2)+l.^2.*(1+2.*t.*((-1)+T+eta.^2.*g.^2.*r.^2.*T)))))...
            ,0,inf,0,2*pi,0,3*sigma);
    case 'pa'
        F=...
            integral3(@(r,theta,ra)...
            ...
            (exp(1).^((1/2).*(((-1)+eta.^2).*g.^2.*r.^2+r.^2.*((-2)+l.^2.*((-2) ...
              ...
              exp(1).^((sqrt(-1)*2).*theta).*cosh(ra)+sinh(ra))).^2+(-1).*norm(( ...
              -1).*exp(1).^((sqrt(-1)*(-1)).*theta).*eta.*g.*r.*(exp(1).^((sqrt( ...
              -1)*2).*theta).*cosh(ra)+sinh(ra))).^2)).*pi.^(-1).*r.*((-2)+(-1) ...
              .*e.*t+l.^2.*(2+((-2)+e).*t)).^(-1).*(2+l.^2.*((-2)+((-2)+e).*t.*( ...
              (-1)+T))+e.*(t+(-1).*t.*T)).^(-1).*(l.^4.*(2+((-2)+e).*t).*((-2)+ ...
              eta.^2.*g.^2.*r.^2.*(2+((-2)+e).*t)+((-2)+e).*t.*((-1)+T))+(2+e.* ...
              t).*((-2)+eta.^2.*g.^2.*r.^2.*(2+e.*t)+e.*t.*((-1)+T))+4.*eta.*g.* ...
              l.^3.*r.^2.*t.^(1/2).*(2+((-2)+e).*t).*T.^(1/2)+(-4).*eta.*g.*l.* ...
              r.^2.*t.^(1/2).*(2+e.*t).*T.^(1/2)+l.^2.*(8+(-2).*eta.^2.*g.^2.* ...
    ...
    case 'pc'
        F=...
            ...
            (exp(1).^((1/2).*(((-1)+eta.^2).*g.^2.*r.^2+r.^2.*((-2)+l.^2.*((-2) ...
              ...
              exp(1).^((sqrt(-1)*2).*theta).*cosh(ra)+sinh(ra))).^2+(-1).*norm(( ...
              -1).*exp(1).^((sqrt(-1)*(-1)).*theta).*eta.*g.*r.*(exp(1).^((sqrt( ...
              -1)*2).*theta).*cosh(ra)+sinh(ra))).^2)).*pi.^(-1).*r.*(2+l.^2.*(( ...
              -2)+((-2)+e).*t.*((-1)+T))+e.*(t+(-1).*t.*T)).^(-2).*(e.^2.*((-1)+ ...
              l.^2).^2.*t.^2.*((-1)+T).^2+(-2).*e.*((-1)+l.^2).*t.*(1+l.^2.*(( ...
              -1)+2.*t)).*((-1)+T).^2+4.*(l.^2.*(t.*((-1)+T).^2+(-2).*T)+T+ ...
              l.^4.*((-1).*t.*((-1)+T).^2+t.^2.*((-1)+T).^2+T))).^(-1).*(e.^4.*( ...
              (-1)+l.^2).^4.*t.^4.*((-1)+T).^2.*(((-1)+T).^2+eta.^4.*g.^4.* ...
              r.^4.*T+eta.^2.*g.^2.*r.^2.*((-1)+T.^2))+(-2).*e.^3.*((-1)+l.^2) ...
              .^3.*t.^3.*((-1)+T).^2.*(3+(-4).*T+2.*eta.^4.*g.^4.*r.^4.*T+T.^2+ ...
              eta.^2.*g.^2.*r.^2.*((-3)+2.*T+T.^2)+(-2).*eta.*g.*l.*r.^2.*t.^( ...
              1/2).*T.^(1/2).*(2.*((-1)+T)+eta.^2.*g.^2.*r.^2.*(1+T))+l.^2.*((3+ ...
              4.*t.*((-1)+T)+(-1).*T).*((-1)+T)+2.*eta.^4.*g.^4.*r.^4.*((-1)+2.* ...
              t).*T+eta.^2.*g.^2.*r.^2.*((-1)+T).*((-3)+(-1).*T+4.*t.*(1+T))))+ ...
              4.*e.^2.*((-1)+l.^2).^2.*t.^2.*((-1)+T).*((-3)+3.*eta.^2.*g.^2.* ...
              r.^2+4.*T+(-7).*eta.^2.*g.^2.*r.^2.*T+(-1).*eta.^4.*g.^4.*r.^4.*T+ ...
              (-1).*T.^2+2.*eta.^2.*g.^2.*r.^2.*T.^2+eta.^4.*g.^4.*r.^4.*T.^2+( ...
              -2).*eta.*g.*l.*r.^2.*t.^(1/2).*((-1)+T).*T.^(1/2).*(3.*((-1)+T)+ ...
              eta.^2.*g.^2.*r.^2.*(2+T))+(-2).*eta.*g.*l.^3.*r.^2.*t.^(1/2).*(( ...
              -1)+T).*T.^(1/2).*(3.*((-1)+2.*t).*((-1)+T)+eta.^2.*g.^2.*r.^2.*(( ...
              -2)+(-1).*T+3.*t.*(1+T)))+l.^4.*(eta.^4.*g.^4.*r.^4.*(1+(-6).*t+ ...
              6.*t.^2).*((-1)+T).*T+eta.^2.*g.^2.*r.^2.*(3+(-7).*T+2.*T.^2+6.* ...
              t.^2.*((-1)+T).^2.*(1+T)+(-3).*t.*((-1)+T).^2.*(3+T))+((-1)+T).*( ...
              3+6.*t.^2.*((-1)+T).^2+(-1).*T+(-3).*t.*(3+(-4).*T+T.^2)))+l.^2.*( ...
              2.*eta.^4.*g.^4.*r.^4.*((-1)+3.*t).*((-1)+T).*T+((-1)+T).*(2.*(( ...
              -3)+T)+t.*((-1)+T).*(3.*((-3)+T)+r.^2.*(1+T)))+eta.^2.*g.^2.* ...
              r.^2.*((-6)+14.*T+(-4).*T.^2+t.*((-1)+T).*(3.*((-3)+2.*T+T.^2)+ ...
              r.^2.*(1+4.*T+T.^2)))))+16.*(2.*eta.*g.*l.*r.^2.*t.^(1/2).*((-1)+ ...
              T).*T.^(1/2)+T+(-2).*eta.*g.*l.^3.*r.^2.*t.^(1/2).*((-1)+T).*T.^( ...
              1/2).*(3+(1+eta.^2.*g.^2).*r.^2.*t.*((-1)+T)+(-2).*t.*T)+(-2).* ...
              eta.*g.*l.^7.*r.^2.*t.^(1/2).*((-1)+T).*T.^(1/2).*(1+(-3).*t.^2+ ...
              2.*t.^3+(-2).*t.*T+6.*t.^2.*T+(-4).*t.^3.*T+(-3).*t.^2.*T.^2+2.* ...
              t.^3.*T.^2+eta.^2.*g.^2.*r.^2.*((-1)+t).*t.*((-1)+T).*((-1)+t+t.* ...
              T))+l.^2.*((-4).*T+t.*((-1)+T).*((-1)+eta.^2.*g.^2.*r.^4.*((-1)+T) ...
              +(-1).*T+(-1).*(1+eta.^2.*g.^2).*r.^2.*((-1)+3.*T)))+l.^8.*(T+t.*( ...
              (-1)+T).*(1+T+eta.^2.*g.^2.*r.^2.*((-1)+3.*T))+t.^4.*((-1)+T).^2.* ...
              (((-1)+T).^2+eta.^4.*g.^4.*r.^4.*T+eta.^2.*g.^2.*r.^2.*((-1)+T.^2) ...
              )+(-1).*t.^3.*((-1)+T).^2.*(3+(-4).*T+2.*eta.^4.*g.^4.*r.^4.*T+ ...
              T.^2+eta.^2.*g.^2.*r.^2.*((-3)+2.*T+T.^2))+t.^2.*((-1).*((-3)+T).* ...
              ((-1)+T).^2+eta.^4.*g.^4.*r.^4.*((-1)+T).^2.*T+eta.^2.*g.^2.* ...
              r.^2.*((-3)+10.*T+(-9).*T.^2+2.*T.^3)))+(-2).*eta.*g.*l.^5.*r.^2.* ...
              t.^(1/2).*((-1)+T).*T.^(1/2).*((-3)+3.*t.^2+4.*t.*T+(-6).*t.^2.*T+ ...
              3.*t.^2.*T.^2+r.^2.*t.*((-1)+T).*((-1)+t+t.*T+eta.^2.*g.^2.*((-2)+ ...
              t.*(2+T))))+l.^6.*((-4).*T+t.*((-1)+T).*(eta.^2.*g.^2.*r.^4.*((-1) ...
              +T)+(-3).*(1+T)+(-1).*(1+3.*eta.^2.*g.^2).*r.^2.*((-1)+3.*T))+ ...
              t.^3.*((-1)+T).^2.*(3+(-4).*T+T.^2+eta.^2.*g.^2.*r.^4.*(1+2.*(2+ ...
              eta.^2.*g.^2).*T+T.^2)+r.^2.*((-1)+T).*(1+T+eta.^2.*g.^2.*(3+T)))+ ...
              (-2).*t.^2.*((-1)+T).*((-3)+4.*T+(-1).*T.^2+eta.^2.*g.^2.*r.^4.*(( ...
              -1)+T).*(1+(2+eta.^2.*g.^2).*T)+r.^2.*(((-1)+T).^2+eta.^2.*g.^2.*( ...
              3+(-7).*T+2.*T.^2))))+l.^4.*(6.*T+(-1).*t.*((-1)+T).*(2.*eta.^2.* ...
              g.^2.*r.^4.*((-1)+T)+(-3).*(1+T)+(-1).*(2+3.*eta.^2.*g.^2).*r.^2.* ...
              ((-1)+3.*T))+t.^2.*((-1)+T).*((-1).*((-3)+T).*((-1)+T)+r.^4.*((-1) ...
              +T).*(T+eta.^4.*g.^4.*T+2.*eta.^2.*g.^2.*(1+2.*T))+r.^2.*(2.*((-1) ...
              +T).^2+eta.^2.*g.^2.*(3+(-7).*T+2.*T.^2)))))+(-8).*e.*((-1)+l.^2) ...
              .*t.*((-1)+T).*((-1)+eta.^2.*g.^2.*r.^2+(-1).*T+(-3).*eta.^2.* ...
              g.^2.*r.^2.*T+2.*eta.*g.*l.*r.^2.*t.^(1/2).*T.^(1/2).*((-1).* ...
              eta.^2.*g.^2.*r.^2.*((-1)+T)+2.*T)+(-2).*eta.*g.*l.^5.*r.^2.*t.^( ...
              1/2).*T.^(1/2).*(2.*((-3).*t.*((-1)+T).^2+3.*t.^2.*((-1)+T).^2+( ...
              -1).*T)+eta.^2.*g.^2.*r.^2.*((-1)+T).*(1+3.*t.^2.*(1+T)+(-2).*t.*( ...
              2+T)))+(-2).*eta.*g.*l.^3.*r.^2.*t.^(1/2).*T.^(1/2).*(4.*T+t.*(( ...
              -1)+T).*(6.*((-1)+T)+r.^2.*(1+T))+2.*eta.^2.*g.^2.*r.^2.*((-1)+T) ...
              .*((-1)+t.*(2+T)))+l.^6.*(1+(-6).*t+9.*t.^2+(-4).*t.^3+T+8.*t.*T+( ...
              -21).*t.^2.*T+12.*t.^3.*T+2.*eta.^4.*g.^4.*r.^4.*t.*(1+(-3).*t+2.* ...
              t.^2).*((-1)+T).*T+(-2).*t.*T.^2+15.*t.^2.*T.^2+(-12).*t.^3.*T.^2+ ...
              (-3).*t.^2.*T.^3+4.*t.^3.*T.^3+eta.^2.*g.^2.*r.^2.*((-1)+3.*T+4.* ...
