...
for it in T:
    ...
    f_dir4 += [co.fidelity_alphabet(it, eps, sigmaD[3])]
...
ax.plot(Tdb, f_dir4, label=r'Direct $\sigma= $' + str(np.round(np.abs(sigmaD[3]),2)), linestyle='-', marker='*', markersize=4, linewidth=1.5)
...
#    f_dt1 = co.fidelity_alphabet(T_eff_up, eps, sigmaD[0])
    # Amplified direct transmission
#    f_dt1 = co.fidelity_alphabet_amp(T_eff_up, eps, sigmaD[0], 1/T_eff_up)
...
#    f_dt2 = co.fidelity_alphabet(T_eff_up, eps, sigmaD[1])
    # Amplified direct transmission
#    f_dt2 = co.fidelity_alphabet_amp(T_eff_up, eps, sigmaD[1], 1/T_eff_up)
...
#    f_dt3 = co.fidelity_alphabet(T_eff_up, eps, sigmaD[2])
    # Amplified direct transmission
#    f_dt3 = co.fidelity_alphabet_amp(T_eff_up, eps, sigmaD[2], 1/T_eff_up)
...
ax.plot(zs, f_up4_avg, label=r'Uplink $\sigma= $' + str(np.round(np.abs(sigmaD[3]),2)), linestyle='--', marker='*', markersize=4, linewidth=1.5)
