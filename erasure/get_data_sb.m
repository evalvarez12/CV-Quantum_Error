...
parfor i = 1:V_num
    ...
    [par2(:,i), F_2(i)] = fmincon(fun_2, [gini, Tini], [],[],[],[], [gmin, Tmin], [gmax, Tmax], [], OptOption);
    [par3(:,i), F_3(i)] = fmincon(fun_3, [gini, Tini], [],[],[],[], [gmin, Tmin], [gmax, Tmax], [], OptOption);
    [par12(:,i), F_12(i)] = fmincon(fun_12, [gini, Tini], [],[],[],[], [gmin, Tmin], [gmax, Tmax], [], OptOption);
    [par13(:,i), F_13(i)] = fmincon(fun_13, [gini, Tini], [],[],[],[], [gmin, Tmin], [gmax, Tmax], [], OptOption);
    [par23(:,i), F_23(i)] = fmincon(fun_23, [gini, Tini], [],[],[],[], [gmin, Tmin], [gmax, Tmax], [], OptOption);
